...
## 入口牛 NPC「牛来」（2026-09-12 新增）
- 脚本 `scripts/archive_entrance_npc.gd`，模型 `assets/character/niu_lai.glb`，自检 `scripts/check_entrance_npc.gd`（26 项断言）。
- **独立于 `archive_npc_dialogue.gd`**：档案员会开记忆传送门推进主线，入口的牛只陪聊。别把两者合并。
- 站位 `(-1.6, 0, -1.25)` / yaw 0.95 / scale 1.18（高 1.31m vs 奶蛙 1.05m）。传送门落点 `(-4.5, 4.0, 0.0)`，走廊可走 `x∈[-5,37] z∈[-1.9,1.9]`。
- 素材是 2026 年爆火动画**《牛来》**的主角（母子手搓五年、上映 9 天票房 7169 元、"牛来"谐音"牛市来"、绊倒体=半导体、官号排队玩"X来"）。对话立意：**它靠被围观而被记住，却从没被真正看见** —— 与档案馆"怕被遗忘"的主题互为镜像。
